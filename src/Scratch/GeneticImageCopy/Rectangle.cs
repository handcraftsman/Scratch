...
namespace Scratch.GeneticImageCopy
{
	public class Rectangle : Shape, IShape
	{
		...
		public Rectangle(IList<byte> bytes, int bitmapWidth, int bitmapHeight)
		...
		public void Draw(Graphics graphics, int offsetX, int offsetY)
		{
			...
			graphics.FillRectangle(new SolidBrush(Color), offsetPoints[0].X - Points[1].X, offsetPoints[0].Y - Points[1].Y, Points[1].X, Points[1].Y);
		}
